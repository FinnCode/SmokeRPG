package la.iok.finnecho.cq.dto;
 ...
 * 消息实体类
 */
public class CQMessageDTO implements Serializable {
	...
	//用于发送私聊、讨论组、群消息的方法
	public CQMessageDTO(Long qQ, String msg, String fun) {
		super();
		QQ = qQ;
		Msg = msg;
		Fun = fun;
	...
	public CQMessageDTO(String fun) {
		super();
		Fun = fun;
	}

	//用于发送赞的方法
	public CQMessageDTO(Long qQ, String fun, Integer count) {
		super();
		QQ = qQ;
		Fun = fun;
		Count = count;
	...
	//用于接收语音的方法
	public CQMessageDTO(String fun, String file, String format) {
		super();
		Fun = fun;
		File = file;
		Format = format;
	...
	//用于取成员信息的方法
	public CQMessageDTO(Long qQ, String fun, Long group) {
		super();
		QQ = qQ;
		Fun = fun;
		Group = group;
	...
	public String toArrayJson(){
		...
		ArrayList<CQMessageDTO> arr = new ArrayList<CQMessageDTO>();
		arr.add(this);
		map.put("data", arr);
		Gson g = new Gson();
		return g.toJson(map);
